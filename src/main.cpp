...
void loop() {
  //Simple serial print test to check if calibration function is working
  
  struct Offset calibration;
  offset_test(calibration);

  Serial.println("Acceleration Offset");
  Serial.print("X: "); Serial.print(calibration.offset_accel_x, 2);
  Serial.print(" Y: "); Serial.print(calibration.offset_accel_y, 2);
  Serial.print(" Z: "); Serial.println(calibration.offset_accel_z, 2);

  Serial.println("Rotation Offset");
  Serial.println("--------------------");
  Serial.print("X: "); Serial.print(calibration.offset_gyro_x, 2);
  Serial.print(" Y: "); Serial.print(calibration.offset_gyro_y, 2);
  Serial.print(" Z: "); Serial.println(calibration.offset_gyro_z, 2);
